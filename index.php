							...
							<div class="col-md-4">
								<div class="featured-box featured-box-primary featured-box-text-left">
									<div class="box-content">
										<div class="row">
											<div class="col-md-9">
												<h2>MAKOVATION 2.0</h2>
<!--												<h6><strong>Open to all</strong></h6>-->
											</div>
											<div class="col-md-3">
												<div class="align-right">
													<img src="KIITEcell/logo/makovation.png" style="width: 50px;height: 40px;">
												</div>
											</div>
										</div>
										<div class="row">
											<div class="col-md-12">
												<p>MAKOVATION is a moderated hackathon which will run over a course of two days where students can bring out their innovative ideas to the floor which can hear and support them in the future.It is meant to spread awareness about enterpreneurship in the campus.</p>
												 <h6><strong>Date: 6th to 7th October' 18</strong></h6>
